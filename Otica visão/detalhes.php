...
/*
* Código para a ver detalhes das informações de um unico cadastro de clientes 
...
<body>
	...
	<div class="container">
		...
		<div class="container">
			<body>
			<label style="float: center;"><h2>Cliente - detalhes</h2></label>
			<a class="btn btn-success" style="margin: 15px; padding: ; float: right" href="index.php" role="button">Cadastrar</a>
<div id="ret" style="overflow:scroll; height:500px; width:100%; overflow:auto">
